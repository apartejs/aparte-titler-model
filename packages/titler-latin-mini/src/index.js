// @aparte/titler-latin-mini — the runtime plus the smaller-vocabulary model (17 languages, int3, ~96 KB), ready to use with no configuration.
//
...
// `import modelUrl from "@aparte/titler-latin-mini/model?url"`. See the README.
