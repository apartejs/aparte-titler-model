...
```js
// anywhere else: copy node_modules/@aparte/titler-latin-mini/model/titler-v1.2-latin-mini-int3.bin
// into the directory you serve, then
const titler = await loadTitler("/models/titler-v1.2-latin-mini-int3.bin");
```
