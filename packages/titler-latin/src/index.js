// @aparte/titler-latin — the runtime plus the default model (17 languages, int3, ~133 KB), ready to use with no configuration.
//
...
// `import modelUrl from "@aparte/titler-latin/model?url"`. See the README.
